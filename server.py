...
async def generate_docx(json_filename: str = Form(...), pic_onsite: str = Form("")):
    ...
    try:
        result = subprocess.run(
            [NODE_BIN, str(js_script), '--input', str(json_path), '--output', str(docx_path), '--pic-onsite', pic_onsite],
